/* disass98.c -- macrocode disassembler for System 98
 *
 * This is the same as System 78; and hasn't been ported from System 98!
 *
...
{
	PRIN1("%o", constant_page[addr]);
}

static void
disassemble_address(uint32_t fef, uint32_t reg, uint32_t disp, bool second_word, uint32_t pc)
{
	PRIN1(" ");
